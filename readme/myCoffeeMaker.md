...
Μια απαίτηση που παρουσιάζεται στον προσομοιωτή μας, είναι να υποδεικνύουμε στον χρήστη ότι η προσομοίωση είναι σε εξέλιξη, ιδιαίτερα αφού αυτή η διαδικασία αναμένεται να είναι μακροχρόνια.
...
```
Στη συνέχεια δε, όταν ο προσομοιωτής ξεκινήσει τη λειτουργία του, καλείται η μέθοδος animateSimulration για όσο διαρκεί η προσομοίωση, η οποία καλεί διαδοχικά ένα frame ανά 100 ms.
...
Τέλος θα πρέπει να σημειωθεί ότι στην τελική εκδοχή του κώδικα, έχει προστεθεί στα αρχεία η δυνατότητα της σχετικής αναφοράς στο μονοπάτι κάθε εξωτερικού αρχείου, ώστε να αυξηθεί η μεταφερσιμότητα της εφαρμογής.
